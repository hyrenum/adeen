...
import { NotesDialog } from "Client/Component/Dialog/Notes";
import { ShareDialog } from "Client/Component/Dialog/Share";
import { SurahInfoDialog } from "Client/Component/Dialog/Surah-Info";
import { surahList, juzData, type AssembledVerse } from "Server/API/Quran";
...
import { useReadingSession } from "Client/Hook/Use-Reading-Session";
...
import { AudioControls } from "Client/Component/Quran/Record";
import { useDeepgram } from "Client/Hook/Use-STT";
  ...
  return (
    <Layout hideFooter>
      ...
      <ShareDialog open={shareDialog.open} onOpenChange={(open) => setShareDialog({ ...shareDialog, open })}
        surahId={surahId} surahName={surah.englishName} ayahId={shareDialog.ayahId}
        verseText={shareDialog.verseText} translation={shareDialog.translation} />
      <SurahInfoDialog open={surahInfoDialog} onOpenChange={setSurahInfoDialog}

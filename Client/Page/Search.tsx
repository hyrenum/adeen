...
import { 
  ...
  getCategoryLabel,
  type VerseResult
} from "Client/Component/Search/Utility";
import type { SearchResult, SearchCategory } from "Client/Component/Search/Types";
...
export default function SearchPage() {
  ...
  const duaResults = useMemo(() => searchAid(query), [query]);

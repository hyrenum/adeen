...
import { Tooltip, TooltipContent, TooltipTrigger, TooltipProvider } from "Client/Component/UI/tooltip";
          ...
          <TooltipTrigger asChild>
            <button
              className={cn(
                ...
                isPlaying ? "text-primary" : "text-foreground [.high-contrast_&]:group-hover:text-white [.high-contrast_&]:dark:group-hover:text-black"
              )}
              style={{ fontSize }}
